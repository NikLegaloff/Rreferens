...
function Draw(m) {
    ...
    if (template.Images != null && template.Images!=undefined)
    template.Images.forEach(function (o, i) {
        var extra = "";
        if (o.Area.H != undefined && o.Area.H != null) extra = "height:" + GetPx(o.Area.H) + ";";
        html += AddLayer(o, "<img style='width:" + GetPx(o.Area.W) + ";" + extra + "' src='" + GetURL(o.ImageId) + "'/>");
    });
