...
public static class Helper
{
    ...
    public static string ToJsonJS(this object subj) => JsonConvert.SerializeObject(subj, Formatting.None, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Include, DefaultValueHandling = DefaultValueHandling.Populate });
